...
import 'package:musik/screens/firend_request_screen.dart';
import 'package:musik/screens/help_support_screen.dart';
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(''), backgroundColor: Colors.tealAccent.shade100, foregroundColor: Colors.black),
      body: Container(
          ...
          child: Column(
            ...
            children: [
              GestureDetector(
                ...
                child: CircleAvatar(radius: 48, backgroundColor: Colors.white, child: Icon(Icons.person, size: 60, color: Colors.teal)),
              ),
              SizedBox(height: 24),
