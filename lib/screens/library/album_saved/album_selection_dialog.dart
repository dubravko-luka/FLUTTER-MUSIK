              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  onTap: () {
                    ...
                    addMusicToAlbum(context, albums[index]['id'], musicId, onAddedToAlbum);
                  },
                );
              },
            ),
          ),
          actions: [TextButton(onPressed: () => Navigator.of(context).pop(), child: Text('Cancel', style: TextStyle(color: Colors.teal)))],
        );
      },
    );
  }
